...
```{r creating and summarizing the 4 models}
...
# The Hedge's G for pitch valiability is -0.55 (95%, CIs: -1.06, 0.09), and in our model we get an effect size estimate of -0.17 (95%, CIs: -0.32, 0.20). Both of these numbers are negative, indicating that the pitch valiability is smaller for schizophrenics than for the control group.

# The Hedge's G for proportion of spoken time is -1.26 (95%, CIs: -2.26, 0.25), and in our model we get an effect size estimate of -0.06 (95%, CIs: -0.32, 0.20). Both of these numbers are negative, indicating that the proportion of spoken time is smaller for schizophrenics than for the control group. However, in our data, the effect size is only slightly below 0, so the difference between the groups is not as big in our data.

# The Hedge's G for speech rate is -0.75 (95%, CIs: -1.51, 0.04), and in our model we get an effect size estimate of -0.19 (95%, CIs: -0.45, 0.06). Both of these numbers are negative, indicating that the rate of speech is lower for schizophrenics than for the control group. However, these effect sizes for proportion of spoken time and for speech rate are numerically smaller (closer to zero) than the values of Hedge's G from the meta study. In the meta study, Fusaroli et al. concluded that their findings did not show conclusive evidence for clear acoustic markers of schezophrenia, and since our findings are even less significant (xxx), we cannot with certainty say that schizophrenics display lower speech rates and lower proportions of spoken time than the control group.

# The Hedge's G for pause duration is 1.89 (95%, CIs:  0.72, 3.21), and in our model we get an effect size estimate of 0.20 (95%, CIs: -0.03, 0.43). Both of these numbers are positive, indicating that the pause duration is longer for schizophrenics than for the control group. In the meta study, Fusaroli et al. wrote that this G value was one of the four that more strongly indicated a difference between the groups, however, they still did not call it conclusive evidence. Since our effect size if was closer to 0 than their G, we can again say, that our analysis does not indicate that pause duration is an acoustic marker of schizophrenia.
