...
#Creating a list with the names of our files as character strings
pitch <- list.files(path="/Users/al/RStudio/Semester 3/Experimental-Methods-3/Assignment 3/EM3_A3_P1/Pitch/", pattern="*.txt")

#Creating empty dataframe
data <- NULL
path <- "/Users/al/RStudio/Semester 3/Experimental-Methods-3/Assignment 3/EM3_A3_P1/Pitch/"

#Run forloop that goes one by one and reads each file
for (n in 1:length(pitch)) {
    d <- read.delim(paste0(path, Pitch [n]))
    data <- rbind(data, d)
}


#We can create an empty column which is a string character, and tell the loop that this equals to the filename
read_pitch <- function("/Users/al/RStudio/Semester 3/Experimental-Methods-3/Assignment 3/EM3_A3_P1/Pitch/Study1D0S101T1_f0.txt") {
    # load data
