...
df <- merge(df, DATA, by = "ID")

# Now we save them
# write.csv(df, "SCZdf.csv")

# Why do we get 17.4 million observations?
# when theyre are 3826 participants (see: filenames_list) and 532 observation per participant (see: d)
# then thouse should be 2.035.432 observations
